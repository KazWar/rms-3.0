...
<template>
    <q-card
        ...
        <div class="quasar">
            <q-icon class="icon" name="help"/>

            <q-tooltip class="tooltip" anchor="center right" self="center left" :offset="[10, 10]">
                <strong> The campaings has already expired</strong>
            </q-tooltip>
        </div>
...
.campaign-card{
    ...
    color:#fff;
    margin-top: 20px;
    transition-property: box-shadow, transform, black;
